...
if sys.platform == "win32":
    PROJECT_ROOT = r"D:\Công việc\1. Dự án Gỗ Minh Long\3. Phát triển ETL dữ liệu\01. ETL"
else:
    PROJECT_ROOT = "/mnt/d/Công việc/1. Dự án Gỗ Minh Long/3. Phát triển ETL dữ liệu/01. ETL"
...
def excel_pipeline_dag():
    ...
    def cleanup_prev_month_files(load_results: dict) -> None:
        ...
        MISA_RAW_DIR = Path(PROJECT_ROOT) / "data" / "raw" / "misa"
        today = date.today()
